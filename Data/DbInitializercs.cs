...
namespace UrsuAlexandra_Lab2.Data
{
 ...
 new Book{Title="De veghe in lanul de secara",Author="J.D.Salinger",Price=Decimal.Parse("28")},
            ...
            context.SaveChanges();
            var customers = new Lab2_2.Models.Customer[]
            {

 new Lab2_2.Models.Customer{CustomerID=1050,Name="PopescuMarcela",BirthDate=DateTime.Parse("1979-09-01")},
 new Lab2_2.Models.Customer{CustomerID=1045,Name="MihailescuCornel",BirthDate=DateTime.Parse("1969-07-08")},

            };
            foreach (Lab2_2.Models.Customer c in customers)
            {
